...
- [vscode-r-lsp](https://marketplace.visualstudio.com/items?itemName=REditorSupport.r-lsp): R Language Server Protocol Client for VSCode
...
Here are the ones I currently use. Change as needed and your preference. Obs.: by the time you're reading it they may be changed, since R support is on active development.
