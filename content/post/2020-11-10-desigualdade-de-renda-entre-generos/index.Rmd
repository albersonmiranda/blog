...
```{r escala sawilowsky, echo = FALSE}
...
diferencas %>%
  ...
  labs(
    ...
    y = "",
    size = "rem. média\n(homem)",
    title = "DESIGUALDADE DE GÊNERO EM VITÓRIA",
    subtitle = "As diferenças salarias evidenciam o longo caminha na superação da colocação\nda mulher como profissional de segunda categoria no mercado de trabalho",
    caption = "fonte: Rais 2017 | elaboração: Alberson Miranda"
  ) +
  theme(
...
Dentre essas profissões que escolhemos, vamos analisar o tamanho do efeito para a maior diferença — os cargos de executivo (dirigentes e diretores).