...
Para uma visão completa sobre a classe `miom` e seus métodos, confira a vignette: [Análise Multirregional de Insumo-Produto](https://albersonmiranda.github.io/fio/articles/multiregional_analysis.html).
...
Para um exemplo completo sobre como trabalhar com dados do WIOD, confira a vignette: [Trabalhando com WIOD](https://albersonmiranda.github.io/fio/articles/wiod_2014_analysis.html).
